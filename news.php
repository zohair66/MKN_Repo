...
<div id="wrapper">
    <div id="menuthispage">
        <div id="main">
            ...
            <div id="blog" class="menu" onmouseenter="select5()" onmouseleave="out5()"><a href="#" id="subblog" class="submenu"></a>

                <p class="text">آخرین اخبار</p></div>
            <div id="mail" class="menu" onmouseenter="select6()" onmouseleave="out6()"><a href="contactus.php" id="submail"
                                                                    class="submenu"></a>
